...
class LdaSampler(object):
    ...
    def run(self, matrix, maxiter=50):
        """
...
if __name__ == "__main__":
    ...
    sampler = LdaSampler(N_TOPICS, alpha=0.1, beta=1)
